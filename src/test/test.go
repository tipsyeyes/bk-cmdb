...
func init() {
	...
	flag.StringVar(&tConfig.ZkAddr, "zk-addr", "192.168.23.161:2181", "zk discovery addresses, comma separated.")
	...
	flag.StringVar(&tConfig.MongoURI, "mongo-addr", "mongodb://192.168.23.161:27017/cmdb", "mongodb URI")
